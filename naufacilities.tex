...
For the DISCOVER case study and robotics applications, the Intelligent Control Systems (ICONS) Lab at NAU and the DISCOVER project will provide all the necessary equipment for the study, with no needs specific to this project.
That includes a laptop with a powerful GPU for intensive computation, 8 CrazyFlie drones, 4 autonomous ground robots, a radio-based localization system (consisting of 6 beacons and 8 sensors), and all required software packages (MATLAB, ROS, and others).
