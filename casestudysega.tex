...
Ultimately, these failures could %cause scientific data to be lost or invalidated and, even worse, could
affect, %damage
...
On the other hand, reliable operation is important, as noted above. %, because access to manually fix problems can be problematic even with current installations, and in the future this problem will only grow.
